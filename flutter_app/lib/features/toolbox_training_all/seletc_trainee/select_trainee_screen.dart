          ...
          children: [
            Padding(
              ...
              child: SizedBox(
                ...
                child: TextField(
                  ...
                  onChanged: (value) {
                    selectTraineeController.searchQuery.value = value;
                  },
                ),
              ),
            ),
            ...
            Obx(
              () {
                final groupedContacts =
                    selectTraineeController.getGroupedContacts();
                      ...
                      children: [
                        ...
                        Obx(() {
                          List<Map<String, String>> filteredContacts =
                              selectTraineeController.getFilteredContacts();
                          return ListView.builder(
                            shrinkWrap: true,
                            physics: NeverScrollableScrollPhysics(),
            ...
            Padding(
              ...
              child: AppElevatedButton(
                text: "Add",
                onPressed: () {
                  selectTraineeController.confirmSelection();
                  Get.off(ToolboxAddTraineeScreen());
                },
              ),
            ),
