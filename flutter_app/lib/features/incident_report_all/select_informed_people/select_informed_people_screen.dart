...
class SelectInformedPeopleScreen extends StatelessWidget {
  ...
  final SelectInformedPeopleController selectInformedPeopleController =
      Get.put(SelectInformedPeopleController());
            ...
            Padding(
              ...
              child: SizedBox(
                ...
                child: TextField(
                  ...
                  onChanged: (value) {
                    selectInformedPeopleController.searchQuery.value = value;
                  },
                ),
              ),
            ),
            ...
            Obx(
              () {
                final groupedContacts =
                    selectInformedPeopleController.getGroupedContacts();
                      ...
                      children: [
                        ...
                        Obx(() {
                          List<Map<String, String>> filteredContacts =
                              selectInformedPeopleController
                                  .getFilteredContacts();
                          return ListView.builder(
                            shrinkWrap: true,
                            physics: NeverScrollableScrollPhysics(),
                                  ...
                                  children: [
                                    Obx(
                                      () => Transform.scale(
                                        scale: 1.1,
                                        child: Checkbox(
                                          value: selectInformedPeopleController
                                                      .selectedContacts[
                                                  contact['name']!] ??
                                              false,
                                          onChanged: (value) {
