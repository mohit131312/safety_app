          ...
          children: [
            Padding(
              ...
              child: SizedBox(
                ...
                child: TextField(
                  ...
                  onChanged: (value) {
                    selectInjuredController.searchQuery.value = value;
                  },
                ),
              ),
            ),
            ...
            Obx(
              () {
                final groupedContacts =
                    selectInjuredController.getGroupedContacts();
                      ...
                      children: [
                        ...
                        Obx(() {
                          List<Map<String, String>> filteredContacts =
                              selectInjuredController.getFilteredContacts();
                          return ListView.builder(
                            shrinkWrap: true,
                            physics: NeverScrollableScrollPhysics(),
            ...
            Padding(
              ...
              child: AppElevatedButton(
                text: "Add",
                onPressed: () {
                  selectInjuredController.confirmSelection();
                },
              ),
            ),
