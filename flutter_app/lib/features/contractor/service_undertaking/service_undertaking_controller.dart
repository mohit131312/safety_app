...
class ServiceUndertakingController extends GetxController {
  ...
  final SignatureController signatureContactorController = SignatureController(
    penStrokeWidth: 3,
  ...
  @override
  void dispose() {
    signatureContactorController.dispose();
    super.dispose();
  }

  void clearContactorSignature() {
    signatureContactorController.clear();
  }

  Future<void> saveContactorSignature() async {
    try {
      Uint8List? signatureBytes =
          await signatureContactorController.toPngBytes();
