                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Obx(
                      () => DropdownButtonFormField<String>(
                        ...
                        value: staffDocumentationController
                                .selecteddoctype.value.isNotEmpty
                            ? staffDocumentationController.selecteddoctype.value
                            : null,
                        items: staffDocumentationController.doctype
                  ...
                  Obx(
                    () => staffDocumentationController.otherImageCount < 1
                        ? GestureDetector(
                            onTap: () {
                              staffDocumentationController.pickotherImages();
                            },
                            child: Container(
                              alignment: Alignment.center,
                              width: SizeConfig.widthMultiplier * 82,
                    ...
                    children: [
                      Container(
                        ...
                        child: IconButton(
                          ...
                          onPressed: () {
                            staffDocumentationController.alllabourImgData
                                .clear();
                            staffDocumentationController
                                .alllabourImgDataCount.value = 0;
                            staffDocumentationController.adharImageCount.value =
                                0;
                            staffDocumentationController.otherImageCount.value =
                                0;

                            staffDocumentationController.labourAdharcard
                                .clear();
                            staffDocumentationController.labourotherimg.clear();
