      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            Padding(
              ...
              child: SizedBox(
                ...
                child: TextField(
                  ...
                  onChanged: (value) {
                    selectSafetyInformedPeopleController
                        .searchInformedPeopleQuery.value = value;
                  },
                ),
              ),
            ),
            ...
            Obx(
              () {
                final groupedContacts = selectSafetyInformedPeopleController
                    .getGroupedInformedPeople();
                                    ...
                                    Obx(
                                      () => Transform.scale(
                                        ...
                                        child: Checkbox(
                                          ...
                                          value:
                                              selectSafetyInformedPeopleController
                                                          .selectedInformedPeople[
                                                      contact['name']!] ??
                                                  false,
                                          onChanged: (value) {
                                            selectSafetyInformedPeopleController
                                                .toggleInformedPeopleSelection(
                                                    contact['name']!);
                                          },
            ...
            Padding(
              ...
              child: AppElevatedButton(
                ...
                onPressed: () {
                  selectSafetyInformedPeopleController
                      .confirmSelectionInformedPeople();
